...
test.describe.configure({ 
  mode: 'parallel', // Changed from 'serial' to 'parallel' for better performance
  timeout: 60000 
});

// Test data constants
const TEST_USER = {
  email: 'nusaibah.noor@balinexus.com',
  password: 'Flyonhoveringabove11.'
};

const UNAUTHORIZED_USER = {
  email: 'balinexus@gmail.com'
};

const BASE_URL = 'https://office-gate.balinexus.com';
const AUTH_STATE_PATH = 'test-results/auth-state/auth.json';

const ERROR_MESSAGES = {
  LOGIN_FAILED: 'Login failed - element not found or interaction failed',
  REDIRECT_FAILED: 'Redirect to expected page failed',
  SESSION_INVALID: 'Session state is not as expected'
};
